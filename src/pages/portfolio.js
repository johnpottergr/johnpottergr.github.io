    ...
    <Layout title="Portfolio">
      <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', color: '#F5F5F5' }}>
        ...
        <p>
          ...
          Explore all my articles <a href="https://github.com/johnpottergr/Technical-Article-Portfolio/blob/main/article-by-industry.md">here</a>, or jump straight to a curated list of data migration guides <a href="https://github.com/johnpottergr/Software-Dev-Data-Migration-Guides/blob/main/Data-Migration-Guides.md">here</a>.
        </p>
