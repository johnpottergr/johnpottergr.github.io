...
<li style={{ marginBottom: '1.5rem' }}>
  ...
  <li style={{ marginBottom: '1.5rem' }}>
    <strong style={{ color: '#5ED1A5' }}>Sketch an outline for your audience: </strong>
    I build a reader-focused outline with clear, friendly headers. The goal is to keep the structure intuitive and easy to navigate.
  </li>
  <li style={{ marginBottom: '1.5rem' }}>
